...
BEGIN_MESSAGE_MAP(CautooDlg, CDialogEx)
  ...
  ON_WM_TIMER()
  ON_BN_CLICKED(IDC_IN, &CautooDlg::OnBnClickedIn)
  ON_BN_CLICKED(IDC_OUT, &CautooDlg::OnBnClickedOut)
END_MESSAGE_MAP()
...
void CautooDlg::OnClickedAct()
{
  ...
  this->m_operate.Format(_T("%s %s workmode: %d\r\n"), this->m_operate, _T("backup will run!"), m_workMode);
  UpdateData(FALSE);
...
int CautooDlg::monkdomouseclick(int v_x, int v_y, int v_sleepms = 0)
{
  SetCursorPos(v_x, v_y);
  //mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
  //mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
...
void CautooDlg::OnBnClickedIn()
{
  // TODO: Add your control notification handler code here
  UpdateData(true);
  this->m_operate = _T("080000");
  UpdateData(false);
}


void CautooDlg::OnBnClickedOut()
{
  // TODO: Add your control notification handler code here
  UpdateData(true);
  this->m_operate = _T("170000");
  UpdateData(false);
}
